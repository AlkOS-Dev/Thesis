...
\begin{itemize} 
    ...
    \item x86_64 Architecture -- targeting the AMD64 archietcture only. 
...
Responsible for scheduling, process and thread lifecycle management, context switching, scheduling algorithms, thread sleeping mechanisms, and timer devices.
