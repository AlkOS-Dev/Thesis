...
enum class EventClockState : u8 {
    ...
    kPeriodic,      // Clock \begin{lstlisting}[caption={Clock Driver Structure}, label={lst:clockDriver}]
      struct alignas(arch::kCacheLineSizeBytes) ClockRegistryEntry : data_structures::RegistryEntry {
        /* Clock numbers */
        u64 frequency_kHz; // Frequency in kHz
        u64 ns_uncertainty_margin_per_sec;  
      ...
      \end{lstlisting}is in periodic mode
...
\textbf{UserPriority user_priority} may be specified by the User Space to inform the scheduler that some threads are more important than others.

\textbf{bool preserve_floats} specifies whether on context switches floting point state is preserved.
...
\subsection{Preserve Floats}
TODO

\subsection{GS and FS Segments}
TODO
...
\subsubsection{Sleeping Queue}
TODO

\subsection{Waiting On Event}
TODO
