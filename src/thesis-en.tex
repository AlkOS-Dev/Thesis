...
Once the staging directory has been fully populated, it must be transformed into a single binary image conforming to a specific filesystem format, such as FAT, EXT2, or an archive-based format.
...
\subsection{Developing User Space Applications}
...
\begin{itemize} 
    ...
    \item \textbf{Max Heap Size} -- 16~GB -- The maximum virtual address range available for a user space process's heap.
