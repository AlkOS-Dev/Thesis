...
Responsible for storage and file system management (including the abstraction layer and implementation of the FAT file system family), the standard C library (libc), the system interface (syscalls and libc extensions), and hardware interaction via ACPI and other drivers.
