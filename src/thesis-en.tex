...
When the CPU calls the handling function it 

As it might be obvious but function handling interrupts slightly differs from usual function we write and compiler generates, and thus those functions must be define in assembly instead.
Major problem with compiler generated function is that it modifies the stack before and after the function code 
