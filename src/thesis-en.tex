...
\begin{figure}[htbp]
  ...
  \resizebox{1\textwidth}{!}{%
    ...
    \draw [short] (2.5,16) -- (17.25,16);
    \draw [short] (2.5,13.5) -- (17.25,13.5);
...
\subsubsection*{Memory Grants} Due to the strict isolation of address spaces in the microkernel architecture, processes cannot directly access the memory of others. To facilitate the exchange of large data structures without violating protection boundaries, Minix 3 provides a capability-based mechanism known as \textit{Memory Grants}, accessed via the \texttt{safecopy} API \cite{minix_safecopy}.
