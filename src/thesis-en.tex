...
\begin{itemize} 
    ...
    \item \textbf{Context Transition} -- A bootstrapping mechanism within the kernel to finalize initialization and jump to user space to begin executing user code.
