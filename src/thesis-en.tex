...
By adopting this approach, the container manipulates pointers that already exist within the object structure. A typical implementation of this pattern using C++ templates is shown in \ref{lst:intrusiveNodesExample}.
