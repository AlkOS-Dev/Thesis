...
\begin{cppcode}[caption={Round Robin Pseudo Code}, label={lst:rr_pseudo_code}]
...
\begin{cppcode}[caption={Userspace Jump C++ code}, label={lst:userSpaceJump}]
...
\begin{nasmcode}[caption={Userspace Jump NASM code}, label={lst:userSpaceJumpNasm}]
; c_decl
