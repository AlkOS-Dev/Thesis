...
Before proceeding to writing actual kernel code we must first do some preparation on our development tools and development environments. Below we can find brief description of needed things.
...
\subsection{Architecture Abstraction}
TODO: KRYCZKA
...
How does the kernel handle such diverse set of methods of querying the memory? This is a part of a bigger topic --- namely Hardware / Architecture Abstraction --- and will be discussed in more detail in \todo[inline]{add label to hardware abstraction layer / problem}
