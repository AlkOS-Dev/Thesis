...
On x86-64 if some type of interrupt takes place it has some unique number, which maps directly to the entry in table called \textbf{Interrupt Descriptor Table}
