...
\begin{itemize} 
    ...
    \item \textbf{System Call Interface} --- A high-performance dispatch mechanism utilizing \texttt{syscall}/\texttt{sysret} instructions with a wide array of implemented services.
