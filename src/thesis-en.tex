...
\end{enumerate}
\todo[inline]{Cite appropiate sources here for each of the enumerated items}
...
\todo[inline]{cite https://devicetree-specification.readthedocs.io/en/stable/flattened-format.html}
...
\todo[inline]{Citations to intel manual for all the mentioned features}
...
\end{itemize}
\todo[inline]{Cite some reliable source that would confirm this}
...
\todo[inline]{find references and fact check this all}
