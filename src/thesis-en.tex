...
These counters, which are used during process termination to determine when the process can be fully deallocated, track the numbers of live threads and threads awaiting cleanup.
