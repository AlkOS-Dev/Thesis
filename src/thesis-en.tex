...
\begin{figure}[htbp]
    ...
    % Arrow from Virtual Offset to Physical Offset (Circular from right)
    \draw[arrow, dashed] (off.east) to[out=0, in=0, looseness=1.5] node[right, font=\tiny, text=gray, xshift=2pt] {Copy} (off_part.east);
